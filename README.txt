...
This is the readme for EngineTest, try to keep it up to date with any information future-you will wish past-you
...
- File > Open > select the top level folder of this project ( i.e. EngineTest) > Ok.
...
- To run the project find EngineTest.java (which will be in under src/main/java/enginetest) and right click > Run 'EngineTest'
