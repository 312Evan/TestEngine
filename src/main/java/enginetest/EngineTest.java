...
public class EngineTest extends SimpleApplication {
    ...
    public void simpleInitApp() {
        ...
        cubeSpawner.CreateTexturedCube(new Vector3f(20, 0.01f, 20), new Vector3f(0, 0.1f, 0), new Vector3f(0, 0, 0), "Textures/asphalt.jpg", 5, 5, 1);
        ...
        modelManager.createModel("Models/building.fbx", "Textures/buildingTexture.png", new Vector3f(0, 0, -30), new Vector3f(0.01f, 0.01f, 0.01f), new Vector3f(300, 0, 0), 1);
        modelManager.createModel("Models/oldcar2.fbx", "Textures/oldcar2.png", new Vector3f(3.5f, 0, 0), new Vector3f(0.025f, 0.025f, 0.025f), new Vector3f(300, 0, 0), 1);
